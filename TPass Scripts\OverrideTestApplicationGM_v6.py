...
try:
    ...
    elif(len(tertiaryId) > 4 and tertiaryId[0] == 'U' and tertiaryId[1] == 'M'):    #tertiaryId = model designator
    ...
    MainTPassScripting.InterfaceUiLogger("MES", newTestApplicationScriptFileName + " VIN = " + secondaryId + " MD = " + tertiaryId, False, False)
...
#   Date: 01082025
#   Version: 6.0
#   Change: S233 is identified by MD=UMxxx, per sam bowin
#   Date: 12232024
#   Version: 5.0
