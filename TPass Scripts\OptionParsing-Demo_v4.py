...
# Application Engineer:  Set Part Number Tag Names required for Test Application and the Test Application Script File Name
#
partNumberTags = set(["IPC","ICS","TCM","IRC","AMP","SDM","UPA","AOS","FCM","VPM","BCM","CGM","CSM","ONS","SIB","LRR","HFP","HFPF","HFPR","RAD","PEPS","HVAC","MSM","MSMP","SADS","VCU","MFC","AFL","TCP","DMS","EBOOST","ELM","EOCM","HDLM","MSB","PAM","PFCM","LGM","SCL","VKM","WCM","BCMOPSOFT","CSMOPSOFT","ECC"])                                                                                                                                                                                                                                                                                
#
#########################################################################################################################################
