...
try:
    ...
    rawCanDataWithoutRev = rawCanDataPartNumberHex[:-2]

    TestAppLogger.Info("Part Number Check Python Script:  Raw Can Data Part Number = {0}", rawCanDataPartNumberHex)
    TestAppLogger.Info("Part Number Check Python Script:  Raw Can Data Part Number without Revision = {0}", rawCanDataWithoutRev)
    ...
    processedPartNumber = bytearray.fromhex(rawCanDataWithoutRev).decode()
...
#	Date: 05032022
#	Version: 3.0
#	Change: No Compare Version
#	Date: 10082021
#	Version: 2.0
#	Change: Fixed issue processing can response
#	Date: 01012019
#	Version: 1.0
