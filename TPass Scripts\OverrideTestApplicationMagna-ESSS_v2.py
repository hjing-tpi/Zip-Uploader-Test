...
try:
    ...
    if str(MainTPassScripting.StartTestCycleTriggerType) == str(MainTPassScripting.TriggerType.ManualEntry):
        if activeOptionCodes.Contains("KTB1S1B1"):
            if (PartNumbers.ContainsKey("KTB1BUCKLES") == True):
                PartNumbers.Remove("KTB1BUCKLES") 
        ...
        if activeOptionCodes.Contains("KTB2S2B1"):
            if (PartNumbers.ContainsKey("KTB2BUCKLES") == True):
                PartNumbers.Remove("KTB2BUCKLES") 
        ...
        if activeOptionCodes.Contains("KTB3S3B1"):
            if (PartNumbers.ContainsKey("KTB3BUCKLES") == True):
                PartNumbers.Remove("KTB3BUCKLES") 
