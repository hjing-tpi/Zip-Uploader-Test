...
#            if MainTPassScripting.RunTestCycle("SwitchTestDelay.json", "OptionCodes-Tesla.json", input, True, True, False):
            if MainTPassScripting.RunTestCycle("SwitchTestDelay - test concurrency.json", "OptionCodes-Tesla.json", input, True, True, False):
                isSuccess = True
            else:
                isSuccess = False
