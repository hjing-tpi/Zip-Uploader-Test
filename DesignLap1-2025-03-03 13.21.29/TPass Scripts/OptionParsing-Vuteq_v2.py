...
try:
    ...
    #Debug
    #BuildData = "85149099;4D21165124137348;OPTIONS"
    ...
    if BuildData == "":
        ...
        if len(buildDataFields) >= numberOfFieldsRequired:
            ...
            #parse options in field 3
            options = buildDataFields[2].split(",")
            #MainTPassScripting.InterfaceUiLogger("Vuteq", "Option Parsing Script:  Number of Options = " + str(len(options)), False, False)
            for option in options:
                ...
                if option != "":
                    ...
                    MainTPassScripting.InterfaceUiLogger("Vuteq", "Option Parsing Script:  Added option = " + option, False, False)
                    TPassLogger.Debug("Option Parsing Script: Added Configured Option Code ({0}) found in build data", option)
        else:
