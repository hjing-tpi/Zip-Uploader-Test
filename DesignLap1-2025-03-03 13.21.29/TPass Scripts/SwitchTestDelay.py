...
#
#testApplicationScriptFileName = "ZERVChassisTest.json"
testApplicationScriptFileName = "SwitchTestDelay.json"
#testApplicationScriptFileName = "GM_T1xx_EoT_01.json"
...
try:
        ...
        input="111111"
        input = MainTPassScripting.GetInputKeyPad("", False)
#       input = MainTPassScripting.GetInputKeyPad("Password", True)
#        input = MainTPassScripting.GetInputKeyBoard("Password")
...
#        TPassLogger.Info("GetInputKeyBoard() Job Entered = " + input)
        if input != "":
            ...
            if MainTPassScripting.RunTestCycle(testApplicationScriptFileName, optionCodeFileName, input, False, True, False):
#            if MainTPassScripting.RunTestCycle("SwitchTestDelay - NewUI.json", optionCodeFileName, input, True, True, False):
                isSuccess = True
            else:
                isSuccess = False
