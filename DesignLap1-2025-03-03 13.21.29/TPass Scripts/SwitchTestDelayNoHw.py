...
testApplicationScriptFileName = "SwitchTestDelayNoHw.json"
...
#        TPassLogger.Info("GetInputKeyBoard() Job Entered = " + input)
        if input != "":
            ...
            if MainTPassScripting.RunTestCycle(testApplicationScriptFileName, "OptionCodes-Tesla.json", input, False, True, False):
