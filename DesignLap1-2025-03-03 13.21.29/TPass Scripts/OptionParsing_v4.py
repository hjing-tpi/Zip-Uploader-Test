...
partNumberTags = set(["ICS","HVAC","DCSD","CMCM","SGW","TBM2","SCCM","ESM","ITBM",])
#
#########################################################################################################################################

try:
    PartNumbers.Add("ICS", "68465684AF")
    PartNumbers.Add("HVAC", "52080472AX")
    PartNumbers.Add("DCSD", "12345678XX")
    PartNumbers.Add("CMCM", "68465150AX")
    PartNumbers.Add("SGW", "68536453AQ")
    PartNumbers.Add("TBM2", "12345678XX")
    PartNumbers.Add("SCCM", "6NE99TRMAX")
    PartNumbers.Add("ESM", "12345678XX")
    PartNumbers.Add("ITBM", "12345678XX")
