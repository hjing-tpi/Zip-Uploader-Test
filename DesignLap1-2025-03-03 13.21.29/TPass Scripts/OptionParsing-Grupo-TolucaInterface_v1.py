...
try:
    ...
    if BuildData == "":
        ...
        if File.Exists(partNumberFile):
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Part Number File Received - " + partNumberFile, False, False)

            #Read contents and delete file
            partNumbers = File.ReadAllText(partNumberFile)
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Part Numbers Received - " + partNumbers, False, False)
            ...
            for part in parts:
                    if len(part) < 11:
                        ...
                        MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Part field not at least 11 characters log and will be discarded - " + part, True, False)
                        continue
                    part = part.replace(' ', '')
                    partNumber = part[:10]
                    partName = part[10:]
                    if PartNumbers.ContainsKey(partName):
                        ...
                        MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Part Tag found twice in the build data.  First occurrence will be used - " + partName + " = " + partNumber, True, False)
                    else:
                        ...
                        MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Part - " + partName + " = " + partNumber, False, False)
            try:
        ...
        if secondaryId[0:1] == 'N':
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + "2022", False, False)
        if secondaryId[0:1] == 'P':
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + "2023", False, False)
        if secondaryId[0:1] == 'R':
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + "2024", False, False)
        if secondaryId[0:1] == 'S':
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + "2025", False, False)
        if secondaryId[0:1] == 'T':
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + "2026", False, False)
        if secondaryId[0:1] == 'V':
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + "2027", False, False)
        if secondaryId[0:1] == 'W':
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + "2028", False, False)
        if secondaryId[0:1] == 'X':
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + "2029", False, False)
        ...
        while index < optionCount*3:
            ...
            MainTPassScripting.InterfaceUiLogger("Toluca SQL Interface", "Option Parsing Script:  Added Configured Option Code - " + optionName, False, False)
            index += 3
