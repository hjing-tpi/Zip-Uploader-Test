            ...
            for testInx in range(len(testAppResults.MainTestApplication.TestCycle[groupInx][subGroupInx].TestSteps)):
                ...
                if (testStep.Name == "MarquardtKtbSeatBuckleTest"):
                    ...
                    if (testStep.MarquardtKtbSeatBuckleTest.DeviceId == 1):
                        if (str(testStep.TestStepResults.TestResults) == str(TestResults.OptionCodeNotTested)):
                            testSeat1Status = "1"
                        elif (str(testStep.TestStepResults.TestResults) == str(TestResults.Pass)):
                            testSeat1Status = "2"
                        elif (IsTestFailed(str(testStep.TestStepResults.TestResults))):
                            testSeat1Status = "3"
                    ...
                    for sequentialTestStep in testStep.MarquardtKtbSeatBuckleTest.KtbSequentialTestSteps:
                        ...
                        if (str(sequentialTestStep.TestStepResults.TestResults) != str(TestResults.NotTested) and str(sequentialTestStep.TestStepResults.TestResults) != str(TestResults.OptionCodeNotTested)):
                            SetProcessData(sequentialTestStep.TestDataReporting.NumberOfMessagesSent, str(sequentialTestStep.TestData.NumberOfMessagesSent))
                            SetProcessData(sequentialTestStep.TestDataReporting.Buckle1Latched, str(sequentialTestStep.TestData.Buckle1Latched))
                            SetProcessData(sequentialTestStep.TestDataReporting.Buckle2Latched, str(sequentialTestStep.TestData.Buckle2Latched))
                            SetProcessData(sequentialTestStep.TestDataReporting.Buckle3Latched, str(sequentialTestStep.TestData.Buckle3Latched))
                            SetProcessData(sequentialTestStep.TestDataReporting.LastReceivedKtbMessage, str(sequentialTestStep.TestData.LastReceivedKtbMessage))
...
try:
    try:
        testResultsText = testResultsText + testSeat1Status + ";"
        testResultsText = testResultsText + testSeat2Status + ";"
        testResultsText = testResultsText + testSeat3Status + ";"
