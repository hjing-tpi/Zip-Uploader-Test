...
try:
        ...
        MainTPassScripting.InterfaceUiLogger("MES", "TestFlowControl Script", True, True)
...
#            TPassLogger.Warn("Main Button Script:  Error Running Quick Test Cycle")
        ...
        if MainTPassScripting.RunTestCycle("TestFlowControl.json", "OptionCodes-Tesla.json", "987654", False, True):
            isSuccess = True
        else:
            isSuccess = False
