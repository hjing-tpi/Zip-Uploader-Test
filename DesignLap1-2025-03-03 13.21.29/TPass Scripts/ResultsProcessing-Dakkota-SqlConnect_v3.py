#Create a Dakkota Test Results Record and format and return the Printed Label Text for TPass to send to a printer
...
try:
    ...
    try:
        ...
        MainTPassScripting.InterfaceUiLogger("SQLConnect", "Test Results Processing Script:  Error Reading Test ID File, will default to Tester ID = 0.  Exception Occurred = " + str(inst), True, True)
    ...
    # Set Results to send to Dakkota
    ...
    MainTPassScripting.InterfaceUiLogger("SQLConnect", "Error Creating Results Record.  Exception Occurred = " + str(inst), True, True)
    isSuccess = False
...
try:
    try:
        ...
        MainTPassScripting.InterfaceUiLogger("SQLConnect", "Results File Written - " + resultsFile, False, False)
    except Exception as inst:
...
#	Date: 05262023
#	Version: 2.0
#	Change: Fixed formatting issue with Faults preventing more than one fault from being sent by SQLConnect
#	Date: 05042022
#	Version: 2.0
