...
#            if MainTPassScripting.RunTestCycle("TestFlowControl.json", "OptionCodes-Tesla.json", input, False, True):
            if MainTPassScripting.RunTestCycle("AllTestStepCommandsSeatDemo.json", "OptionCodes-Demo.json", input, False, True, False, False):
                isSuccess = True
            else:
                isSuccess = False
