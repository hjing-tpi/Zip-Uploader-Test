...
#
testApplicationScriptFileName = "GM_BT1xx_EoT_01 - Copy.json"
...
try:
        ...
        if input != "":
            ...
            if MainTPassScripting.RunTestCycle(testApplicationScriptFileName, optionCodeFileName, input, True, True, False):
                isSuccess = True
            else:
                isSuccess = False
