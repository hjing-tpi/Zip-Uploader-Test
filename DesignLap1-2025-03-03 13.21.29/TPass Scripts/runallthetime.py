...
try:
    ...
    if MainTPassScripting.RunTestCycle("IO Board Checkout (32 Ch).json", "32 Ch Options.json", runTestCycleId, False, True):
#    if MainTPassScripting.RunTestCycle("GM Tester v01.json", "GM Options v01.json", runTestCycleId, False, True):
        isSuccess = True
    else:
        isSuccess = False
