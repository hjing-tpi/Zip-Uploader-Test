...
#
testApplicationScriptFileNameFront = "PassFRONT.json"
testApplicationScriptFileNameMid = "PassMID.json"
testApplicationScriptFileNameRear = "PassREAR.json"
...
try:
    ...
    #MainTPassScripting.OverrideResultsScreenDisplayTimeSec(10)
    ...
    if MainTPassScripting.RunTestCycle(testApplicationScriptFileNameFront, optionCodeFileName, runTestCycleId):
        MainTPassScripting.WaitForTPassReady()
        if MainTPassScripting.RunTestCycle(testApplicationScriptFileNameMid, optionCodeFileName, runTestCycleId, False, True, True):
            MainTPassScripting.WaitForTPassReady()
            if MainTPassScripting.RunTestCycle(testApplicationScriptFileNameRear, optionCodeFileName, runTestCycleId, False, True, True):
                isSuccess = True
            else:
                isSuccess = False
...
#   Version: 4.0
#   ChangeBy: RMM
#   Change: Run three tests consecutively 
#   Date: 01052022
#   Version: 3.0
#   ChangeBy: RMM
