#Create a IAC Test Results Record and format and return the Printed Label Text for TPass to send to a printer
...
def SetFault(faultId, faultDescription):
    ...
    if (numberFaultsAdded < maxNumberFaultsToSave and faultId != ""):
...
# Create Results file for PLC Interface to process
try:
    try:
        testResultsText = testResultsText.rstrip(",")
        MainTPassScripting.InterfaceUiLogger("PLCInterface", "Test Results - " + testResultsText, False, False)
