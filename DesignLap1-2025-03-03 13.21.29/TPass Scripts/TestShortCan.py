...
try:
        ...
        MainTPassScripting.InterfaceUiLogger("MES", "TestShortCan Script", True, True)
#        if MainTPassScripting.RunTestCycle("TestShortCan.json", "OptionCodes-Tesla.json", "987654", True, False):
#            isSuccess = True
#        else:
#            isSuccess = False
#            TPassLogger.Warn("Main Button Script:  Error Running Quick Test Cycle")
        ...
        if MainTPassScripting.RunTestCycle("TestShortCan.json", "OptionCodes-Tesla.json", "111111", False, True):
            isSuccess = True
        else:
            isSuccess = False
