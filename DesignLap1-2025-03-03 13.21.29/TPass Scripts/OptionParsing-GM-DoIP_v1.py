...
#
partNumberTags = set(["VICM","SRRLF","SRRLR","PTM","EBCM","HUD","IPC","ICS","TCM","IRC","AMP","SDM","UPA","AOS","FCM","VPM","BCM","CGM","CSM","ONS","SIB","LRR","HFP","HFPF","HFPR","RAD","PEPS","HVAC","MSM","MSMP","SADS","VCU","MFC","AFL","TCP","DMS","EBOOST","ELM","EOCM","HDLM","MSB","PAM","PFCM","LGM","SCL","VKM","WCM","BCMOPSOFT","CSMOPSOFT","ECC","WCM2"])                                                                                                                                                                                                                                                                                
#
#########################################################################################################################################
    ...
    if keyValuePairs[0] != BuildData:
        for keyValuePair in keyValuePairs:
            ...
            if (key == "VIN"):
                ...
                tertiaryId = value
                if (len(value) > 4 and value[3] == '2' and value[4] == '6'):
                    OptionCodesInBuildData.Add("L233")
                elif (len(value) > 4 and value[3] == '5' and value[4] == '6'):
                    OptionCodesInBuildData.Add("L234")
                if (value.Trim() == "UMC26"):
                    OptionCodesInBuildData.Add("S233UP")
                elif (value.Trim() == "UM226"):
                    OptionCodesInBuildData.Add("S233BASE")
            #elif (key == "PDYR"):
            #    quaternaryId = value
            #elif (key == "CSN"):
            #    quinaryId = value
...
#	Date: 07312024
#	Version: 8.0
#	Change: Added two options S233UP and S233BASE based on Model Designator
#	Date: 01172024
#	Version: 7.0
