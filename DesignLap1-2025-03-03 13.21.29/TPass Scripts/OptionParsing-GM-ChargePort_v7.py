...
try:
    ...
    if (flashHold and BuildData != ""):
        MainTPassScripting.InterfaceUiLogger("GM EDI", "FLASHHOLD not cleared on vehicle, Test Cycle will not run.  DPN = " + primaryId, True, True)
        isSuccess = False
    else:
        isSuccess = True
...
#	Date: 04042023
#	Version: 7
#	Change: If FLASHHOLD != P, don't run test
#	Date: 03082023
#	Version: 6.1
