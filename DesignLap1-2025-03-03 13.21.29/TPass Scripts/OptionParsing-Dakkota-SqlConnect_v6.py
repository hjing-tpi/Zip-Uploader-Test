...
optionInfo.Add("43", ["ESM", "ESM"])
optionInfo.Add("44", ["ITBM", "ITBM"])
optionInfo.Add("45", ["WL", "WL"])
optionInfo.Add("46", ["WD", "WD"])
optionInfo.Add("47", ["CIGAR", "CIGAR"])
#
#########################################################################################################################################
#########################################################################################################################################
# Application Engineer:  Set Part Number Tag Names required for Test Application and the Test Application Script File Name
#
partNumberMinimumETMWD = "2548"
#
#########################################################################################################################################
...
try:
    ...
    #Add ETM-WD part number because it is not broadcasted
    PartNumbers.Add("ETM-WD", partNumberMinimumETMWD)
...
#	Date: 01092023
#	Version: 6.0
#	Change: Add ETM-WD part number because it is not broadcasted 
#	Date: 05022022
#	Version: 3
#	Change: changed position 43 - 46 add 
#	Date: 10062021
#	Version: 1.0
