...
#
testApplicationScriptFileName = "L246_FasciaFRONT_01.json"
...
try:
        ...
        if input != "":
            ...
            if MainTPassScripting.RunTestCycle(testApplicationScriptFileName, "Options.json", input, False, True, False):
                isSuccess = True
            else:
                isSuccess = False
