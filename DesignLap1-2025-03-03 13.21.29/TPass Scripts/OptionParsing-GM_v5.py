...
partNumberTags = set(["AMP","BCM","CGM","CSM","DMS","EBOOST","VCU","ELM","EOCM","FCM","HFPF","HFPR","HLDM","TCP","IPC","LRR","MSB","PAM","ACP","PFCM","PTM","LGM","SCL","SDM","SIB","ONS","VKM","VPM","WCM","UPA","ICS","IRC","HDLM","BCMOPSOFT","CSMOPSOFT"])
#
#########################################################################################################################################
...
#	Date: 08172023
#	Version: 5.0
#	Change: If no build data was retrieved, return False so the operator doesn't get the chance to choose options and run the test
#	Date: 0809021
#	Version: 4.0
