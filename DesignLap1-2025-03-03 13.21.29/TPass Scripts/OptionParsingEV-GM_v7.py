...
try:
    ...
    if keyValuePairs[0] != BuildData:
        ...
        if (OptionCodesInBuildData.Contains("EN0")):    #Engine none
            ...
            if (OptionCodesInBuildData.Contains("MAH") or OptionCodesInBuildData.Contains("MBC") or OptionCodesInBuildData.Contains("MCX") or OptionCodesInBuildData.Contains("MBD") or OptionCodesInBuildData.Contains("MAW")):
                ...
                TPassLogger.Debug("Option Parsing Script: EN0 and (NA RPO) Exist, adding RPOs USDC and USAC");
                OptionCodesInBuildData.Add("USDC")
                OptionCodesInBuildData.Add("USAC")
            elif (OptionCodesInBuildData.Contains("MBM") or OptionCodesInBuildData.Contains("MAM") or OptionCodesInBuildData.Contains("MBI") or OptionCodesInBuildData.Contains("MBB")):
                MainTPassScripting.InterfaceUiLogger("Option Parsing Script", "EN0 and EU Exist, adding RPOs EUDC and EUAC", False, False)
                TPassLogger.Debug("Option Parsing Script: EN0 and EU Exist, adding RPOs EUDC and EUAC");
                ...
                TPassLogger.Debug("Option Parsing Script: EN0 and JP Exist, adding RPOs JPDC and JPAC");
    ...
    if (evaluateStaticHold and staticHold and BuildData != ""):
        ...
        TPassLogger.Info("Option Parsing Script: STATICHOLD not cleared on vehicle, Test Cycle will not run");
        isSuccess = False
        ...
        TPassLogger.Info("Option Parsing Script: FLASHHOLD not cleared on vehicle, Test Cycle will not run");
        isSuccess = False
        ...
        TPassLogger.Info("Option Parsing Script: No EV EN0 RPO, Test Cycle will not run");
        isSuccess = False
    else:
        isSuccess = True
