...
if len(rawCanDataResponse) != requiredRawDataLength:
	TestAppLogger.Warn("Part Number Check Python Script:  Raw Can Data Response length must be equal to {0}.  Length = {1}", requiredRawDataLength, len(rawCanDataResponse))
	isSuccess = False
else:
