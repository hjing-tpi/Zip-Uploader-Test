...
dtcString = ""
# 000F5902FFA22C002FA20600AFC080006DA70700   
# 3 dtcs
# 255 possible
# A22C 002F
# A206 00AF
...
if isMultiFrameMessage:
    try:
        ...
        for x in range(0, numberOfDtcs):
            ...
            hold = hold[:-4]
            try:
                allDtcCollection.Add(hold, statusByte)
            except:
                TestAppLogger.Info("DTC Parsing Python Script:  Error adding DTC to allDtcCollection.  Either a duplicate DTC or not running TPass version 1.5.0.14 or greater.  {0}", hold)
...
#	Date: 08072023
#	Version: 3.0
#	Change: Added populating all DTC collected to be used in DTC Summary Log file
#	Date: 10042021
#	Version: 2.0
