...
#
testApplicationScriptFileName = "KtbWirelessBuckleTest.json"
optionCodeFileName = "KtbWirelessBuckleOptions.json"
#
#########################################################################################################################################
...
try:
    ...
    elif str(MainTPassScripting.StartTestCycleTriggerType) == str(MainTPassScripting.TriggerType.Serial):       #TPass 1.4.0.0 or higher required
        TPassLogger.Debug("StartTestCycle - Trigger Type is Serial")
    ...
    elif str(MainTPassScripting.StartTestCycleTriggerType) == str(MainTPassScripting.TriggerType.Modbus):       #TPass 1.5.0.9 or higher required
        TPassLogger.Debug("StartTestCycle - Trigger Type is Modbus")
...
#   Version: 2.0
#   ChangeBy: RMM
#   Change: Added Modbus Trigger type
#   Date: 04172023
#   Version: 1.0
#   ChangeBy: RMM
