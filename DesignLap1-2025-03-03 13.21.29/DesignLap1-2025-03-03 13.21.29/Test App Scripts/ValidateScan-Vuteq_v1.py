...
# ScanData["HARNESS"] = "[)>06Y8610300000000XP2651060012V8512596504D23094"
##########################################################################################################################################
...
try:
    ...
    TestAppLogger.Info("Scan Data Validation Python Script: Harness Scan = " + ScanData["HARNESS"])
    TestAppLogger.Info("Scan Data Validation Python Script: Door Scan = " + ScanData["DOOR"])
    
    ScannedHarnessPartNumber = ScanData["HARNESS"].Trim().ToUpper().Substring(21,8)
