...
try:
    ...
    if activeOptionCodes.Contains("WD"):
        newTestApplicationScriptFileName = "Dakkota_WD_IP_01.json"
    elif activeOptionCodes.Contains("WL"):
        newTestApplicationScriptFileName = "Dakkota_WL_IP_01.json"
