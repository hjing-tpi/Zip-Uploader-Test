...
#
testApplicationScriptFileName = "P2_DRIVER_SEAT_01.json"
...
try:
    ...
    if reinput != "":
        ...
        if MainTPassScripting.RunTestCycle(testApplicationScriptFileName, optionCodeFileName, reinput, False, True, False, False):
            isSuccess = True
        else:
            isSuccess = False
