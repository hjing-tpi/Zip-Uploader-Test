...
#        if MainTPassScripting.RunTestCycle("AllTestStepCommandsSeatDemo.json", "OptionCodes-Demo.json", "008712", False, True, False):
        if MainTPassScripting.RunTestCycle("LeftSeat.json", "OptionCodes-Demo.json", "008712", False, True, False):
#        if MainTPassScripting.RunTestCycles("LeftSeat.json", "RightSeat.json", "OptionCodes-Demo.json", "008712", False, False, False):
#        if MainTPassScripting.RunTestCycles("PassOrFailLeftSeat.json", "PassOrFailRightSeat.json", "OptionCodes-Tesla.json", "008712", False, False, False):
