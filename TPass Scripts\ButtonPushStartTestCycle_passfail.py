...
try:
        ...
        #MainTPassScripting.OverrideResultsScreenDisplayTimeSec(0)
        ...
        if input != "":
            ...
            if MainTPassScripting.RunTestCycle("PassOrFailOrFatal.json", "Options.json", input, True, True, False, True):
                isSuccess = True
            else:
                isSuccess = False
