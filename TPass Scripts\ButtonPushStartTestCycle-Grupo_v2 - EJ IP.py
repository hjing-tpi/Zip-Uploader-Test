...
#
testApplicationScriptFileName = "EJ_01.json"
optionCodeFileName = "OptionsKM49.json"
#
#########################################################################################################################################
...
try:
        ...
        if input != "":
            # Remove prefix/suffix characters
            input = input.replace('#', '')
            input = input.replace('$', '')
            ...
            if MainTPassScripting.RunTestCycle(testApplicationScriptFileName, optionCodeFileName, input, False, True, False, True):
                isSuccess = True
            else:
                isSuccess = False
...
#   Version: 2.0
#   ChangeBy: RMM
#   Change: Remove prefix/suffix characters from scan input
#   Date: 09182023
#   Version: 1.0
#   ChangeBy: RMM
