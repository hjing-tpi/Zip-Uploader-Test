...
try:
    ...
    if MainTPassScripting.RunTestCycle("Eject All.json", "Options.json", "", True, False, True, True):
        isSuccess = True
    else:
        isSuccess = False
...
#   Version: 2.0
#   ChangeBy: RMM
#   Change: Implemented new parameter bypassOverrideTestAppScript in RunTestCycle() to bypass Test App Override logic
#   Date: 01172021
#   Version: 1.0
#   ChangeBy: RMM
